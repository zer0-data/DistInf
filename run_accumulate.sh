...
# Compression mode: accumulate only
# Block size: 1024
...
for cfg in "${CONFIGS[@]}"; do
  ...
  for task in "${TASKS[@]}"; do
    ...
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method exact --backend eager --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024

    # 2) LSH: frequency_rank (flash)
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method lsh --lsh_mode frequency_rank --backend flash --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024

    # 3) LSH: magicpig_baseline (flash)
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method lsh --lsh_mode magicpig_baseline --backend flash --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024
    ...
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      ...
      --hybrid_ratio 0.5 --backend eager --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024

    # For ratio 0.75, run both orders (primary/secondary swapped)
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method hybrid --hybrid_primary exact --hybrid_secondary lsh --lsh_mode frequency_rank \
      --hybrid_ratio 0.75 --backend eager --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
    ...
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      ...
      --hybrid_ratio 0.5 --backend flash --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024
    ...
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method hybrid --hybrid_primary lsh --hybrid_secondary lsh --lsh_mode magicpig_baseline \
      --hybrid_ratio 0.75 --backend flash --budget $BUDGET --compression_mode accumulate \
      --dataset_config $cfg --dataset_split $task --block_size 1024
    run_cmd $PY run_single_sample.py --model_path "$MODEL_PATH" \
      --method hybrid --hybrid_primary lsh --hybrid_secondary lsh --lsh_mode frequency_rank \
      --hybrid_ratio 0.75 --backend flash --budget $BUDGET --compression_mode accumulate \
